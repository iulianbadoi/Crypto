...
fig2 = figure;
figure(2);
xlabel('Genu skaicius chromosomoje');
ylabel('Populiacijos dydis');
zlabel('Iteraciju skaicius');
title({'Iteraciju skaiciaus priklausomybe nuo genu skaiciaus chromosomoje ';'ir populiacjos dydzio'});
grid on
hold on;
